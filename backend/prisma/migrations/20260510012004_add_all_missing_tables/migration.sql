-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('POST_CREATED', 'POST_LIKED', 'COMMENT_ADDED', 'MENTION', 'SYSTEM');

-- CreateEnum
CREATE TYPE "PostCategory" AS ENUM ('EDUCACION', 'CIENCIAS_NATURALES', 'CIENCIAS_SOCIALES', 'CULTURA', 'COMUNICACION', 'INFORMATICA', 'MATEMATICAS', 'INGENIERIA', 'SALUD', 'ARTES');
...
-- AlterTable
ALTER TABLE "Post" ADD COLUMN     "category" "PostCategory" NOT NULL DEFAULT 'EDUCACION';
